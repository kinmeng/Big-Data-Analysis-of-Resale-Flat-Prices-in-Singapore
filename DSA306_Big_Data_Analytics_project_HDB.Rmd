...
Lines 14 to 667 covers the process of obtaining our final data set. Due to the long run time, the final data set is attached in the Zip file / GitHub repository. Likewise, Parquet files, Spark pipelines and Spark models are all included. 
...
We also convert and save the data set into a Paquet file format. 
